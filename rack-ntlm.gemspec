...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::RubyGemsVersion) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<rubyntlm>, ["0.1.1.sv1"])
      s.add_runtime_dependency(%q<net-ldap>, ["0.3.1.sv1"])
    else
      s.add_dependency(%q<rubyntlm>, ["0.1.1.sv1"])
      s.add_dependency(%q<net-ldap>, ["0.3.1.sv1"])
    end
  else
    s.add_dependency(%q<rubyntlm>, ["0.1.1.sv1"])
    s.add_dependency(%q<net-ldap>, ["0.3.1.sv1"])
